...
public class ReactiveHabitacionValidator {
    ...
    public Mono<Habitacion> validate(Habitacion habitacion) {
        return Mono.fromCallable(() -> {
            ...
            String[] tiposValidos = {"Individual", "Doble", "Suite", "Presidencial"};
            ...
            if (!tipoValido) {
                throw new ReactiveValidationException("Tipo no válido. Debe ser: Individual, Doble, Suite o Presidencial");
            }
